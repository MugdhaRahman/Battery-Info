...
public class HalfGaugeVolt extends AbstractGauge {
    ...
    public HalfGaugeVolt(Context context) {
        super(context);
        init();
    }

    public HalfGaugeVolt(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public HalfGaugeVolt(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    public HalfGaugeVolt(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void drawValueText(Canvas canvas) {
        ...
        canvas.translate((getWidth() / 2f) - ((getRectRight() / 2f) * getScaleRatio()), getHeight() / 2f - 50f * getScaleRatio());
        canvas.scale(getScaleRatio(), getScaleRatio());
        canvas.drawText(getFormattedValue() + " V", 200f, 240f, getTextPaint());
        canvas.restore();
    }
    ...
    private void drawMinValue(Canvas canvas) {
        ...
        canvas.drawText(getFormattedValue(getMinValue()) + " V", 10f + getPadding(), 130f, getRangeValue(getMinValueTextColor()));
        canvas.restore();
    }
    ...
    private void drawMaxValue(Canvas canvas) {
        ...
        canvas.drawText(getFormattedValue(getMaxValue()) + " V", 390f - getPadding(), 130f, getRangeValue(getMaxValueTextColor()));
        canvas.restore();
    }
